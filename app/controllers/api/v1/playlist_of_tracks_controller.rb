class Api::V1::PlaylistOfTracksController < ApplicationController
  def create
    ...
    js_format_flash_message(:success, t("message.add_track_to_playlist", item: @playlist_of_track.track.name))
  end
  ...
  def destroy
    ...
    js_format_flash_message(:success, t("message.delete_track_from_playlist", item: playlist_of_track.track.name))
  end
